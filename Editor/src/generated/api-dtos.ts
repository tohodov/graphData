...
export type TypeCatalogRequest = Schemas["TypeCatalogRequest"];
export type TypeCatalogResponse = Schemas["TypeCatalogResponse"];
export type CardinalityResponse = Schemas["CardinalityResponse"];
export type NodeTypeDefinitionResponse = Schemas["NodeTypeDefinitionResponse"];
export type NodeTypeFieldResponse = Schemas["NodeTypeFieldResponse"];
export type NodeTypeSlotResponse = Schemas["NodeTypeSlotResponse"];
export type TypeReferenceResponse = Schemas["TypeReferenceResponse"];
