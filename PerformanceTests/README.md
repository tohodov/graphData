...
Эта сборка не является тестовым проектом и не использует тестовые фреймворки. Это обычное консольное приложение: оно через reflection находит методы с `[PerformanceScenario]` и запускает их последовательно.
