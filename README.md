...
текущим выбором и графом: снять выбор, удалить выбранные узлы, назначить тип выбранным узлам, создать узел,
соединить ровно один выбранный узел с целью и раскрыть соседей, когда выбран ровно один узел. Операции,
которые неприменимы к текущему выбору, должны оставаться видимыми, но disabled.
