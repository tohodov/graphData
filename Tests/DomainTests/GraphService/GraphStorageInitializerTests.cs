...
//[RelevantTestClass]
//public sealed class GraphStorageInitializerTests : GraphServiceTests
//{
//    [TestMethod]
...
//            await AssertHasCompletionMarkerAsync(new (new(secondStorage, null!), secondStorage, new GraphSearchService(secondStorage), new CancellationTokensAccessorMock()));
//        } finally {
