...
public readonly struct NodePath : IEnumerable<NodeLocalId>, IEquatable<NodePath> {
    readonly ImmutableArray<NodeLocalId> segments;
    readonly int hashCode;
    ...
    public static implicit operator NodePath(NodeGlobalId id) => new NodePath(id.ToArray());
}